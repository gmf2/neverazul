...
public class MENUDAOImpl implements MENUDAO {
	 ...
	 */
	@Override
	public MENU create(long id, String nombre, String[] platos, double precio, int cantidad, String fecha, String turno,
			String[] categorias, String[] bebidas) {
		
		MENU menu = new MENU(id, nombre, platos, precio, cantidad, fecha, turno, categorias, bebidas);
