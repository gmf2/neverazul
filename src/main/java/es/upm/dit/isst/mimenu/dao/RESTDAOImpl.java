...
public class RESTDAOImpl implements RESTDAO {
	...
	public REST create(String nombre, String email, String usuario, int capacidad, String password, String direccion,
		...
		REST rest = new REST(nombre, email, usuario, capacidad, password, direccion,
	...
	public REST read(String usuario) {
		REST rest = ofy().load().type(REST.class).filterKey(Key.create(REST.class, usuario)).first().now();
		return rest;
	}
